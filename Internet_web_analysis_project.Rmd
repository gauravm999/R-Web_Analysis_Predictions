---
title: 'Project : Web Data Analysis'
...
setwd("C:/OLD_LAPTOP/Gaurav/Purdue/4. Data Science with R/3. Practice_Projects")
internet_data<- read.csv("C:/OLD_LAPTOP/Gaurav/Purdue/4. Data Science with R/3. Practice_Projects/Web Data Analysis Project/internet_dataset.csv", header=TRUE)
...
Question 1 (part1)- Data insights:
...
Question-2 (part2) - Model (to check impact of Unique page views on Visits):
...
Model Inpterpretation (Question-2 part2) : 
...
Question-4 (Factors impacting Exit page) - step-wise models:
...
Question-5 (Factors impacting Bounce):
